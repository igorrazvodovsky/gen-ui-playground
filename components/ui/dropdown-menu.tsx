...
function DropdownMenuSubTriggerItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      data-slot="dropdown-menu-sub-trigger-item"
      data-inset={inset}
      className={cn(
        "focus:bg-accent focus:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
...
function DropdownMenuSubTriggerSeparator({
  className,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Separator>) {
  return (
    <DropdownMenuPrimitive.Separator
      data-slot="dropdown-menu-sub-trigger-separator"
      className={cn("bg-border -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
...
function DropdownMenuCheckboxItemIndicator({
  ...
  return (
    <DropdownMenuPrimitive.ItemIndicator
      ...
      className={cn("pointer-events-none absolute left-2 flex size-3.5 items-center justify-center", className)}
      {...props}
    />
  );
}
