...
Read `research-project.md` for full project context. This is a Zettelkasten-based research vault for a generative UI project.
...
├── research-project.md     ← project goals, pipeline, research approach
